        ...
        private void ddlProvider_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (index)
            {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    txtConn.Text = "Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=10.67.89.9)(PORT=1521)))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=ZYRISDB)));User Id=power;Password=Sfx371482;";
                    break;
            }
            //}
        }
